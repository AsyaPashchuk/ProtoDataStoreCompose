...
import com.protodatastorecompose.ui.theme.ProtoDataStoreComposeTheme
...
class MainActivity : ComponentActivity() {
    ...
    private suspend fun setLanguage(language: Language) {
        dataStore.updateData {
            it.copy(
                language = language
                //This is how we use immutable List to add some info into it
